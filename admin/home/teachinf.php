		...
		<div id="container">
			<div>
				...
				<div id="content" name="content">
					<form action="infaction.php?type=insert" method="post" id="jsForm">
					<table cellspacing="0" cellpaddind="0" width="100%" class="biaoge">
					    ...
					    <?php
				            ...
				            while($row = mysqli_fetch_assoc($result)){
								...
								echo '<td>'.$row['time'].'</td>';
								echo '<td>
					                    <a href="editteachinf.php?id='.$row['ID'].'" target="iframe" class="link">编辑</a>
				            ...
				            mysqli_close($link);
				        ?>
				        <tr class="pass-tr" style="margin-top:30px;">
							<td class="pass-td1" style="text-align:center;font-size:14px;">新增教师职称</td>
							<td class="pass-td2"><input type="text" name="code" value="" class="text-word2" placeholder="例:01" required minlength="2" maxlength="12"></td>
							<td class="pass-td2"><input type="text" name="name" value="" class="text-word2" required placeholder="例:讲师"></td>
...
<script type="text/javascript">
    function dodel(id){
        if(confirm ("大人，您确认删除吗？")){
            window.location="infaction.php?type=delete&id="+id;
        }
    }
</script>

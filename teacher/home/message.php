                        ...
                        <?php
                            ...
                            if(mysqli_num_rows($result)){
                                while($row = mysqli_fetch_assoc($result)){
                                    $js='教师'.$row_teach['teachname'];
                                    if($row['targetuser']=='教师'||$row['targetuser']=='所有人'||$row['usernum']==$_SESSION['teachnum']||$row['targetuser']==$js){
                                        $num++;
                                        ...
                                        if($row['usernum']==$_SESSION['teachnum']){
                                            echo '<td>
                                                <a href="javascript:dodel('.$row["ID"].')" target="" class="link red">删除</a>
                                            </td>';
                                        }else{
                                            if($row['usertype']=='管理员'&&$row['targetuser']!==$js){
                                                echo '<td>
                                                    ---
                                                </td>';
                                            }else{

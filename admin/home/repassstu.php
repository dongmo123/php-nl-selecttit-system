<?php
    ...
    //4.定义查询SQL语句，并执行
    $sql = "select password from student where id='{$_GET['id']}'";
	...
	<body>
		<div id="container">
			<div>
				...
				<form action="stuaction.php?type=repassword" method="post" id="jsForm">
					...
					<table cellspacing="0" cellpaddind="0" width="100%" class="repasstable">
	    				...
	    				<tr >
							...
							<td class="flex">
								...
								<div class="text-but2" style="border:none;"><a href="stuaction.php?type=initial&id=<?php echo $_GET['id']?>" target="iframe" class="" style="background:#FFE793;padding:5px;">重置为初始密码</a></div>(初始密码为123456)
							</td>
	    				</tr>
					</table>
				</form>
